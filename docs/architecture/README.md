...
| [ARD-0021](ARD-0021-local-observability-grafana.md) | `[partial]` | Core Prometheus/Grafana dashboards are done; bounded detector-tournament telemetry and its operations dashboard are planned |
