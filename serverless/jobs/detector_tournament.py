...
DEFAULT_SCENARIOS = ["spoofing-like", "layering-like", "quote-stuffing", "liquidity-evaporation"]
...
def _run_one_simulation(run_index: int, scenario: str, detectors: list[str]) -> list[RunResult]:
    ...
    expected_detector = EXPECTED_DETECTORS[scenario]
    ...
    for detector in detectors:
        truth = detector == expected_detector
