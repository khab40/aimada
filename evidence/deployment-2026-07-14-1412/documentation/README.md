...
export ENDPOINT_TOKEN=[REDACTED]
export NEBIUS_ENDPOINT_IMAGE=ghcr.io/<your-org>/[REDACTED]-endpoint:<tag>
export NEBIUS_JOB_IMAGE=ghcr.io/<your-org>/[REDACTED]-jobs:<tag>
...
AIMADA_JWT_SECRET=[REDACTED]
AIMADA_JWT_ISSUER=[REDACTED]
AIMADA_JWT_EXPIRES_IN_SECONDS=[REDACTED]
```
