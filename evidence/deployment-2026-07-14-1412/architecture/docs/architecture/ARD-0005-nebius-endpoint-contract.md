...
- Real Endpoint investigations, response evidence, latency, fallback state, and S3 upload state are archived in the benchmark bundle and frozen deployment evidence.
