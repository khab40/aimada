...
- Real Endpoint investigations with latency, fallback, response, and S3 evidence are archived in the benchmark bundle and frozen deployment evidence; consolidated latency is in the submission index.
