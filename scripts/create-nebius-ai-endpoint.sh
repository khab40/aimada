...
IMAGE="${ENDPOINT_IMAGE:-${NEBIUS_ENDPOINT_IMAGE:-ghcr.io/khab40/ai-market-abuse-detection-arena-endpoint:latest}}"
PLATFORM="${NEBIUS_ENDPOINT_PLATFORM:-gpu-h100-sxm}"
