...
NEBIUS_ENDPOINT_PLATFORM="${NEBIUS_ENDPOINT_PLATFORM:-gpu-h100-sxm}"
NEBIUS_ENDPOINT_PRESET="${NEBIUS_ENDPOINT_PRESET:-1gpu-16vcpu-200gb}"
NEBIUS_ENDPOINT_IMAGE="${NEBIUS_ENDPOINT_IMAGE:-${ENDPOINT_IMAGE:-${IMAGE_NAMESPACE}/ai-market-abuse-detection-arena-endpoint:${TAG}}}"
NEBIUS_JOB_IMAGE="${NEBIUS_JOB_IMAGE:-${JOBS_IMAGE:-${IMAGE_NAMESPACE}/ai-market-abuse-detection-arena-jobs:${TAG}}}"
NEBIUS_ENDPOINT_NAME="${NEBIUS_ENDPOINT_NAME:-market-abuse-arena-ai-endpoint}"
